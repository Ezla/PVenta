...
class Provider(models.Model):
    name = models.CharField(verbose_name='Nombre del proveedor', max_length=45,
                            unique=True)
    phone = models.CharField(verbose_name='Número de teléfono', max_length=12)
...
class ForeignInvoice(models.Model):
    ...
    folio = models.CharField(verbose_name='Folio de la factura', max_length=12)
    amount = models.DecimalField(verbose_name='Monto a pagar', max_digits=8,
                                 decimal_places=2)
    provider = models.ForeignKey(to=Provider, on_delete=models.CASCADE)
    discount = models.PositiveIntegerField(
        verbose_name='Porcentaje de descuento')
    discount_applied = models.BooleanField(verbose_name='Descuento aplicado',
                                           default=False)
...
class Payment(models.Model):
    ...
    invoice = models.ForeignKey(to=ForeignInvoice, on_delete=models.CASCADE)
